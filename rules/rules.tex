...
\\
\frac
{\Phi | \Gamma \vdash e : \tau^\pi \quad \Phi \vdash \tau : +^{\rho}_{\pi'} \quad \Phi | \Gamma', x :^{\pi'} \forall \alpha. \tau^\alpha \vdash e' : \sigma^\pi}
{\Phi | \Gamma, \Gamma' \vdash \text{let}^\downarrow \, x = e; e' : \sigma^\pi} \\
\\
\frac
{\Phi | \Gamma \vdash e : \tau^\pi \quad \Phi \vdash \tau : +^{\rho}_{\pi'} \quad \overline{ \Phi | \Gamma', x :^{\pi'} \forall \alpha. \tau^\alpha \vdash e' : \sigma^\pi }}
{\Phi | \Gamma, \overline {\Gamma'} \vdash \text{case} \, e \, \text{of} \{ \overline {x' \to  e' } \} : \sigma^\pi} \\
\end{gather*}
