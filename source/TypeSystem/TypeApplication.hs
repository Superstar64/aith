...
instance (FreeVariables u p σ, FreeVariables u p e) => FreeVariablesImpl u p (TypeApplication κ σ e) where
  freeVariablesImpl _ (TypeApplication e σ) = freeVariables @u e <> freeVariables @u σ
