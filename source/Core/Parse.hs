...
linear :: Parser Linearity
linear = Linear <$ builtin "linear" <|> Unrestricted <$ builtin "unrestricted" <|> LinearVariable <$> identfier
...
data Post = MacroApp (Term SourcePos) | TypeApp (Type SourcePos) | LinearApp (Linearity)
